...
git remote set-url origin https://${GITHUB_TOKEN}@github.com/thomasdunn/cellular-automata-patterns.git
git push --quiet --follow-tags --set-upstream origin master
